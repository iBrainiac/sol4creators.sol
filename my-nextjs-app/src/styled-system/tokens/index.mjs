const tokens = {
  ...
  "colors.textFixedLight": {
    "value": "#FFFFFF",
    "variable": "var(--colors-text-fixed-light)"
  },
  "colors.primaryBackground": {
    "value": "var(--colors-primary-background)",
    "variable": "var(--colors-primary-background)"
  },
  "fontSizes.headline40": {
    "value": "40px",
    "variable": "var(--font-sizes-headline40)"
  },
  "fontSizes.headline30": {
    "value": "30px",
    "variable": "var(--font-sizes-headline30)"
  },
  "fontSizes.regular16": {
    "value": "16px",
    "variable": "var(--font-sizes-regular16)"
  },
  "fontSizes.regular14": {
    "value": "14px",
    "variable": "var(--font-sizes-regular14)"
  },
  "fontWeights.headline40": {
    "value": "600",
    "variable": "var(--font-weights-headline40)"
  },
  "fontWeights.headline30": {
    "value": "500",
    "variable": "var(--font-weights-headline30)"
  },
  "fontWeights.regular16": {
    "value": "400",
    "variable": "var(--font-weights-regular16)"
  },
  "fontWeights.regular14": {
    "value": "400",
    "variable": "var(--font-weights-regular14)"
  },
  "spacing.-1": {
